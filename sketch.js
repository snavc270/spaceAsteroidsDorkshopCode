...
hitShip = loadImage("assets/asteroids_ship0008.png"); 
...
function draw() {
  ...
  text("asteroids destroyed: " + destroyed, width/2, 60); 
  ...
  asteroids.overlap(ship, loseLife); 
